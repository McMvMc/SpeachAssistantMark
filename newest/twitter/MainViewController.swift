...
class MainViewController: UITableViewController, CLLocationManagerDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    var url = NSURL(fileURLWithPath: NSBundle.mainBundle().pathForResource("hello", ofType: "mp3")!)
